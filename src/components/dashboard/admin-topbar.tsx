...
export function AdminTopbar({
  ...
  return (
    <header className="sticky top-0 z-30 hidden flex-col gap-4 border-b border-[#1e2235]/8 bg-[#f0f2f5] px-4 py-4 lg:flex lg:flex-row lg:items-center lg:justify-between lg:px-8">
