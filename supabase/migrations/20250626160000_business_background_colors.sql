-- Configurable background colors for customer booking UI and admin dashboard.

ALTER TABLE public.businesses
  ADD COLUMN IF NOT EXISTS background_color text NOT NULL DEFAULT '#0a0a0a',
  ADD COLUMN IF NOT EXISTS admin_background_color text NOT NULL DEFAULT '#f0f2f5';
